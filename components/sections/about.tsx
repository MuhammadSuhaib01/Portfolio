...
import { GraduationCap, Briefcase, Brain, Rocket, Award, Code } from 'lucide-react'
...
export default function About() {
  ...
  const techStack = [
    'Python', 'React.js', 'Flutter', 'Django', 'C#', 'C++', 
    'YOLOv8', 'OpenCV', 'Firebase', 'MySQL', 'Machine Learning', 
    'Computer Vision', 'Arduino', 'PyQt5', 'Tailwind CSS', 'Figma'
  ]
  ...
  const achievements = [
    ...
    },
    {
      icon: Briefcase,
      title: 'Experience',
      description: 'Co-founder at SAOTS, Freelance Developer, and Research Assistant',
      color: 'text-green-400'
    },
    {
      icon: Brain,
      title: 'AI Expertise',
      description: 'YOLOv8, Computer Vision, Machine Learning, and Real-time Processing',
      color: 'text-purple-400'
    },
    {
      icon: Rocket,
      title: 'Key Projects',
      description: 'GhostAI, PhysioTrack, MailGuard AI, and 15+ completed projects',
      color: 'text-pink-400'
    },
    {
      icon: Award,
      title: 'Specializations',
      description: 'Full-stack development, Mobile apps, Embedded systems, and Formal verification',
      color: 'text-yellow-400'
    },
    {
      icon: Code,
      title: 'Innovation',
      description: 'Real-world problem solving through cutting-edge technology solutions',
      color: 'text-red-400'
    }
  ]
        ...
        <ScrollTriggeredAnimation direction="up" delay={0.2}>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              cutting-edge technology and real-world applications. Let me share my journey.
            </p>
          </div>
